...
using Tyuiu.VelizhaninPI.Sprint0.Task7.V0.Lib;
using Tyuiu.VelizhaninPI.Sprint0.Task7.V0.Test;

namespace Tyuiu.VelizhaninPI.Sprint0.Task7.V0
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнил: Велижанин П. И. | ИИПб-23-3 ";
